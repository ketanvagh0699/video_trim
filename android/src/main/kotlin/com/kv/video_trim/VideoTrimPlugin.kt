...
/** VideoTrimPlugin */
class VideoTrimPlugin: FlutterPlugin, MethodCallHandler {
  private lateinit var channel : MethodChannel
  private lateinit var context: Context
  private val executor = Executors.newSingleThreadExecutor()

  override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    channel = MethodChannel(flutterPluginBinding.binaryMessenger, "video_trim")
  ...
  private fun trimVideo(inputFile: File, outputPath: String, startTimeMs: Long, endTimeMs: Long) {
    ...
    var videoFormat: MediaFormat? = null // Store the video track format
    ...
    try {
      ...
      for (i in 0 until trackCount) {
        ...
        // Store video format if it's a video track
      ...
      // Set orientation hint if video track was found
      videoFormat?.let {
        val rotation = it.getInteger(MediaFormat.KEY_ROTATION, 0)
